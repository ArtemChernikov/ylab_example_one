...
import io.ylab.intensive.lesson05.messagefilter.processor.DatabaseProcessor;
import io.ylab.intensive.lesson05.messagefilter.processor.MQProcessor;
...
public class FilterImpl implements Filter {
    ...
    private String replaceSwearWords(List<String> swearWords, String inputMessage) {
        ...
        for (String swearWord : swearWords) {
            ...
            censoredMessage = censoredMessage.replaceFirst(swearWord, censorWord);
        }
