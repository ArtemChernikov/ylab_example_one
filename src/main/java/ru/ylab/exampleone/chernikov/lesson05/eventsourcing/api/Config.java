...
import ru.ylab.exampleone.chernikov.lesson05.eventsourcing.api.connectionwrapper.DatabaseConnectionWrapper;
...
@Configuration
@ComponentScan("ru.ylab.exampleone.chernikov.lesson05.eventsourcing.api")
public class Config {
    @Bean
